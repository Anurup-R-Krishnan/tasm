      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-inline">
        ...
        >
          ...
          <div>
            ...
            <div
              class="flex items-center gap-1 mt-2 text-text-secondary font-metadata text-metadata"
            >
        ...
        >
          ...
          <div class="flex-1 min-h-[280px] flex items-end gap-4 pt-4 pb-8 relative w-full px-8">
            ...
            >
              ...
              <div
                class="w-full border-t border-border-default border-dashed absolute top-1/4"
              ></div>
              <div
                class="w-full border-t border-border-default border-dashed absolute top-2/4"
              ></div>
              <div
                class="w-full border-t border-border-default border-dashed absolute top-3/4"
              ></div>
            </div>
            <!-- Bars -->
            <div
