<template>
  <main class="pl-[248px] min-h-screen">
    <div class="max-w-[1400px] mx-auto p-page-margin">
      <!-- Header Section -->
      <div
        class="flex flex-col md:flex-row md:items-start justify-between gap-stack mb-section-gap"
      >
        <div>
          <div class="flex items-center gap-3 mb-2">
            <button
              class="text-text-secondary hover:text-text-primary transition-colors flex items-center justify-center rounded-full p-1 -ml-1"
            >
              <span class="material-symbols-outlined"> arrow_back </span>
            </button>
            <h1 v-if="request" class="font-h1 text-h1 text-text-primary flex items-center gap-3">
              <span
                class="font-mono-data text-mono-data bg-surface-variant px-2 py-1 rounded text-text-primary"
              >
            ...
            <span
              v-if="request"
              class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-metric-amber text-on-surface-variant border border-amber-200"
            >
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-stack">
        ...
        <div class="lg:col-span-8 flex flex-col gap-stack">
          ...
          <div
            class="bg-surface rounded-2xl border border-border-default p-card-padding shadow-[0_4px_12px_rgba(0,0,0,0.02)] hover:-translate-y-[2px] transition-transform duration-200"
          >
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              <div class="bg-canvas rounded-xl p-4 border border-border-default/50">
                ...
                <span
                  v-if="request"
                  class="font-h3 text-h3 text-text-primary flex items-center gap-2"
                >
              ...
              <div class="bg-canvas rounded-xl p-4 border border-border-default/50">
                ...
                <span class="font-mono-data text-mono-data text-text-primary text-base"> - </span>
              </div>
              <div class="bg-metric-lavender/40 rounded-xl p-4 border border-metric-lavender">
                ...
                <span
                  v-if="request"
                  class="font-mono-data text-mono-data text-tertiary text-lg font-semibold"
                >
            ...
            <div>
              <span
                class="font-table-header text-table-header text-text-secondary block mb-2 uppercase"
              >
              ...
              <div class="bg-surface-subtle p-4 rounded-lg border border-border-default/50">
                <p class="font-body text-body text-text-primary">
                  ...
                  inventory of high-performance machines (16GB+ RAM, dedicated GPU) is depleted.
                  These specific models are required to run the local containerized environments
                  specified by the DevSecOps team.
                </p>
              </div>
            </div>
          </div>
              ...
              <table class="w-full text-left border-collapse">
                <thead>
                  <tr class="bg-surface-subtle border-b border-border-default">
                    ...
                    <th
                      class="font-table-header text-table-header text-text-secondary py-3 px-4 text-right"
                    >
                      Action
                    </th>
                  </tr>
                ...
                <tbody>
                  <tr
                    class="border-b border-border-default hover:bg-metric-amber/20 transition-colors border-l-[3px] border-l-amber-500 bg-amber-50/30"
                  >
                    <td class="py-3 px-4">
                      <div class="flex items-center gap-2">
                        <div
                          class="w-6 h-6 rounded bg-stone-200 flex items-center justify-center font-bold text-xs text-stone-600"
                        >
                          T
                        </div>
                  ...
                  <tr
                    class="border-b border-border-default hover:bg-surface-subtle transition-colors"
                  >
        ...
        <div class="lg:col-span-4 flex flex-col gap-stack">
          ...
          >
            ...
            <div
              class="relative pl-6 border-l-2 border-stone-100 dark:border-stone-800 ml-3 space-y-6"
            >
              <!-- Step 1: Completed -->
              <div class="relative">
                <div
                  class="absolute -left-[35px] top-0 w-6 h-6 rounded-full bg-status-in-stock text-white flex items-center justify-center border-4 border-surface z-10"
                >
                  <span
                ...
                <h3 class="font-h3 text-h3 text-text-primary">Draft Submitted</h3>
              ...
              <div class="relative">
                ...
                <h3 class="font-h3 text-h3 text-text-primary">Dept Head Approved</h3>
                <p class="font-metadata text-metadata text-text-secondary mt-1">
                  Michael Chang • Oct 25, 14:30 PM
                </p>
                <div
                  class="mt-2 p-2 bg-surface-subtle rounded border border-border-default/50 text-sm italic text-text-secondary flex gap-2"
                >
                  <span class="material-symbols-outlined text-stone-400" style="font-size: 16px">
                    format_quote
                  </span>
                  <span> Approved. Essential for Q1 intake. </span>
                </div>
              </div>
              <!-- Step 3: Current -->
              <div class="relative">
                <div
                  class="absolute -left-[35px] top-0 w-6 h-6 rounded-full bg-metric-amber border-2 border-amber-500 flex items-center justify-center border-4 border-surface z-10"
                >
              ...
              <div class="relative">
                <div
                  class="absolute -left-[35px] top-0 w-6 h-6 rounded-full bg-surface border-2 border-border-default flex items-center justify-center border-4 border-surface z-10"
                ></div>
                <h3 class="font-h3 text-h3 text-text-secondary">Procurement Execution</h3>
                <p class="font-metadata text-metadata text-border-default mt-1">Not started</p>
              </div>
            </div>
          </div>
          <!-- Comments Card -->
          <div
            class="bg-surface rounded-2xl border border-border-default p-card-padding shadow-[0_4px_12px_rgba(0,0,0,0.02)] flex-1 hover:-translate-y-[2px] transition-transform duration-200"
          >
            ...
            <div class="space-y-4 mb-6">
              <div class="flex gap-3">
                ...
                >
                  <div class="flex justify-between items-baseline mb-1 gap-4">
                    <span class="font-h3 text-h3 text-text-primary"> Sarah Jenkins </span>
              ...
              <div class="flex gap-3">
                <div
                  class="w-8 h-8 rounded-full bg-tertiary text-white flex items-center justify-center font-bold text-sm mt-1 shrink-0"
                >
                  MC
                </div>
                <div
                ...
                >
                  <div class="flex justify-between items-baseline mb-1 gap-4">
                    <span class="font-h3 text-h3 text-text-primary"> Michael Chang </span>
                    <span class="font-metadata text-metadata text-text-secondary text-[10px]">
                      Oct 25, 14:25 PM
                    </span>
                  </div>
            ...
            <div class="mt-auto">
              <div class="relative">
                <textarea
                  class="w-full bg-canvas border border-border-default rounded-xl p-3 pl-3 pr-10 font-body text-body focus:ring-2 focus:ring-amber-500 focus:border-amber-500 resize-none h-[80px]"
                  placeholder="Add a note or request more info..."
                ></textarea>
                <button
                  class="absolute right-2 bottom-2 p-1.5 bg-text-primary text-white rounded-lg hover:bg-on-surface-variant transition-colors flex items-center justify-center"
                >
