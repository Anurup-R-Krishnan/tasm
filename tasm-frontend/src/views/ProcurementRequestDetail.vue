    ...
    <div class="flex flex-col md:flex-row md:items-start justify-between gap-stack mb-section-gap">
      <div>
        <div class="flex items-center gap-3 mb-2">
          ...
          <span
            v-if="request"
            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-metric-amber/20 text-surface-tint border border-metric-amber/30"
          >
            <span class="w-1.5 h-1.5 rounded-full bg-surface-tint mr-1.5"> </span>
            {{ request.status }}
          </span>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-stack">
        ...
        >
          ...
          <div class="overflow-x-auto border border-border-default rounded-xl">
            <table class="w-full text-left border-collapse">
              ...
              <tbody>
                <tr
                  class="border-b border-border-default hover:bg-metric-amber/20 transition-colors border-l-[3px] border-l-surface-tint bg-metric-amber/10"
                >
                  <td class="py-3 px-4">
                    <div class="flex items-center gap-2">
                      <div
      ...
      <div class="lg:col-span-4 flex flex-col gap-stack">
        ...
        >
          ...
          <div class="relative pl-6 border-l-2 border-border-default ml-3 space-y-6">
            <!-- Step 1: Completed -->
            <div class="relative">
              <div
            ...
            <div class="relative">
              <div
                class="absolute -left-[35px] top-0 w-6 h-6 rounded-full bg-metric-amber border-2 border-surface-tint flex items-center justify-center border-4 border-surface z-10"
              >
                <div class="w-2 h-2 rounded-full bg-surface-tint"></div>
              </div>
              <h3 class="font-h3 text-h3 text-surface-tint font-bold">Pending Finance</h3>
              <p class="font-metadata text-metadata text-text-secondary mt-1">
