        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div class="flex items-center justify-between mb-4">
              <span
                class="font-metadata text-metadata text-text-secondary uppercase tracking-wider"
              >
                Total Cost
              </span>
              <span
          ...
          >
            ...
            <div class="flex items-center justify-between mb-4 relative z-10">
              ...
              <span
                class="material-symbols-outlined text-status-in-stock bg-white/50 p-1.5 rounded-md"
              >
