<template>
  <main class="space-y-section-gap pb-24">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-section-gap">
      ...
      <div class="flex items-center gap-3">
        <button
          class="px-4 py-2 bg-surface border border-border-default rounded-lg font-h3 text-h3 text-text-primary hover:bg-surface-subtle transition-colors shadow-sm active:translate-y-0.5 flex items-center gap-2"
        >
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-stack mb-section-gap">
      ...
      <!-- Metric 3 -->
      <div
        class="bg-surface rounded-[16px] p-card-padding border border-border-default shadow-sm hover:-translate-y-0.5 transition-transform cursor-pointer"
      >
        <div class="flex justify-between items-start mb-2">
        ...
        <div class="font-kpi-number text-kpi-number text-text-primary mb-1">31-Dec-2025</div>
        <div class="font-metadata text-metadata text-text-secondary">712 days remaining</div>
      </div>
    </div>
    <!-- Leased Assets (now Lease Agreements List) -->
    <div
      class="lg:col-span-12 bg-surface rounded-[16px] border border-border-default shadow-sm overflow-hidden flex flex-col"
    >
      <div
