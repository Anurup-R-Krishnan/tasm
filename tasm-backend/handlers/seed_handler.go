...
func SeedDatabase(c *gin.Context) {
	...
	discs := []models.AuditDiscrepancy{
		{AssetName: "Dell Laptop 5420", AssetTag: "AST-992-LX", IssueType: "Location Mismatch", LastKnownLocation: "C-Wing, Server Rm 2", ScannedLocation: "B-Wing, IT Store", RecommendedAction: "Update to B-Wing"},
		{AssetName: "MacBook Pro 16", AssetTag: "MAC-844-PR", IssueType: "Missing", LastKnownLocation: "C-Wing, Desk 104", ScannedLocation: "Not Scanned", RecommendedAction: "Investigate / Mark Lost"},
		{AssetName: "Unknown Monitor", AssetTag: "MON-112-DK", IssueType: "Unregistered", LastKnownLocation: "None", ScannedLocation: "C-Wing, Meeting Rm B", RecommendedAction: "Register New Asset"},
		{AssetName: "Dell Monitor 27", AssetTag: "AST-945-LX", IssueType: "Location Mismatch", LastKnownLocation: "C-Wing, Desk 88", ScannedLocation: "C-Wing, Desk 89", RecommendedAction: "Update to Desk 89"},
		{AssetName: "Server Rack B", AssetTag: "SRV-004-PR", IssueType: "Missing", LastKnownLocation: "Data Center Alpha", ScannedLocation: "Not Scanned", RecommendedAction: "High Priority Investigate"},
	}
	for _, d := range discs {
	...
	assets := []models.Asset{
		{
			...
			WarrantyExpiry: time.Now().AddDate(0, 6, 0),
		},
		{
			...
			WarrantyExpiry: time.Now().AddDate(-1, 0, 0),
		},
		{
